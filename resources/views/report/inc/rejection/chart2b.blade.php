...
<script>
function drawChart2b(result) {
  var rejection_data = result.data_chart_2b
  var part_name = Object.values(result.part_name)
  var rejection_data_arr = Object.keys(rejection_data).map((key) => rejection_data[key]);
  var rejection_type = Object.keys(result.data_chart_2b)
  Highcharts.chart('chart2b', {
      chart: {
          type: 'column'
      },
      title: {
          text: 'Pareto (TOP 10) Rejection Based on Part'
      },
      xAxis: {
          categories: part_name
      },
      yAxis: {
          min: 0,
          title: {
